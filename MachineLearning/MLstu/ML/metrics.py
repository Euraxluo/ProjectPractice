...
def accuracy_score(y_true,y_predict):#accuracy
    
    assert y_true.shape[0] == y_predict.shape[0],"the lines of y_true & y_predic must be equal"
    
    return sum(y_predict == y_true) / len(y_true)

def mean_squared_error(y_true,y_predict):
    """ 计算y_ture和y_predict之间的MSE """
